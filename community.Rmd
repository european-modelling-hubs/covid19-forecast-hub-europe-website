...
The ECDC hosts weekly calls which any forecasting team is welcome to join. Each week a different team is invited to present and discuss forecasting methods. Slides and extra content provided by the teams is provided [here](https://github.com/epiforecasts/covid19-forecast-hub-europe/tree/main/docs/presentations).
