...
<div class="alert alert-warning">
  <strong>Warning!</strong> Due to rapid spread of the Omicron variant, case numbers could be undergoing changes that are not accounted for in all of the models. Please treat the forecasts with particularly caution at this time..
</div>
