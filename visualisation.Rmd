...
<div class="alert alert-warning">
  <strong>Warning!</strong> The visualisation app is currently slow to load. We are working to fix this. In the meantime, you may have to wait a few minutes until the app appears.
</div>
