...
<div class="alert alert-warning" font-size: 15px>
  ...
  <ul>
    <li>Due to <strong>differences</strong> in surveillance systems and data sources, we recommend focusing on trends rather than on absolute numbers <strong>to provide an indicator of the current epidemiological situation</strong>.</li>
    <li><strong>Please note that</strong> forecasts are a characterisation of the surveillance systems, <strong>and the forecasts will hence reflect the reported data</strong>.</li>
  </ul>
</div>
