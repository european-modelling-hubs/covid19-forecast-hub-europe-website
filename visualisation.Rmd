...
<p id="limitations">
Please be aware of the [limitations](background.html) when interpreting the forecasts. We recommend to focus on the ensemble which would be expected to give the most reliable forecasts. For horizons beyond one week case forecasts in particular can rapidly become unreliable, especially in times of changing non-pharmaceutical interventions. The individual models that constitute the ensemble have been contributed by independent teams. They are shown for transparency but should not be taken on their own without fully acknowledging their assumptions and limitations and engaging with the listed authors.
</p>
