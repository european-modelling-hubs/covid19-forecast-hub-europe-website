...
<div class="alert alert-warning">
  <strong>Warning!</strong> Update 10.03.2023: Due to recent [changes in data sources](https://github.com/covid19-forecast-hub-europe/covid19-forecast-hub-europe/tree/main/data-truth#cases-and-deaths), forecast models are currently being adapted. Many countries are undergoing changes in testing criteria and reporting procedures. We recommend focusing on trends rather than absolute numbers when interpreting the forecasts.
</div>
