...
<div class="alert alert-warning">
  <strong>Warning!</strong> The visualisation app is currently slow to load. We are working to fix this. In the meantime, waiting for a few minutes should make the app apear.
</div>
